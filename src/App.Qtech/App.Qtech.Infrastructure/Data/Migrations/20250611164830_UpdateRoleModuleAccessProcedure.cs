...
{
    /// <inheritdoc />
    public partial class UpdateRoleModuleAccessProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = """"
                    ALTER PROCEDURE [dbo].[sp_ManageRoleModuleAccess]
                ...
                BEGIN
                    ...
                    BEGIN
                		IF @RoleName IS NOT NULL
                			SELECT DISTINCT ModuleName FROM RoleModuleAccesses WHERE RoleName = @RoleName
                    END
